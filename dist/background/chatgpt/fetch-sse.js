...
export function fetchSSE(resource, options) {
    var _a, e_1, _b, _c;
    return __awaiter(this, void 0, void 0, function* () {
        const { onMessage } = options, fetchOptions = __rest(options, ["onMessage"]);
        const resp = yield fetch(resource, fetchOptions);
        if (!resp.ok) {
        ...
        try {
            for (var _d = true, _e = __asyncValues(streamAsyncIterable(resp.body)), _f; _f = yield _e.next(), _a = _f.done, !_a;) {
                _c = _f.value;
                _d = false;
                try {
                    const chunk = _c;
